...
/**
 * @ClassName QueReg
 * @Description 单选题规约，前端传回的试题规约
 * @Author Administrator
 * @Date 2020-04-24 9:38
 **/
public class SCQueReg {
    //题型的数量
    private Integer scQueNum;
    //简单题难度数量
    ...
    public Integer getScQueNum() {
        return scQueNum;
    }

    public void setScQueNum(Integer scQueNum) {
        this.scQueNum = scQueNum;
    }
